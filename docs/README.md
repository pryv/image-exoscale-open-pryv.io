...
<center>
<button name="button" onclick="window.location.href='https://portal.exoscale.com/u/perki@pryv.com/compute/instances/add?template-name=Open%20Pryv.io%20v1&instance-type=Small&os-group=other&disk=20'">Launch Open Pryv.io on Exoscale</button><br>
